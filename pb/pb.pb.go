...
func (x *SMTPData) GetData() string {
	if x != nil {
		return x.Data
	}
	return ""
...
func (x *SMTPData) GetFrom() string {
	if x != nil {
		return x.From
	}
	return ""
...
func (x *SMTPData) GetRecipients() []string {
	if x != nil {
		return x.Recipients
	}
	return nil
...
func (x *SMTPResult) GetSuccess() bool {
	if x != nil {
		return x.Success
	}
	return false
...
var file_pb_proto_rawDesc = []byte{
	0x0a, 0x08, 0x70, 0x62, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x02, 0x70, 0x62, 0x22, 0x52,
	0x0a, 0x08, 0x53, 0x4d, 0x54, 0x50, 0x44, 0x61, 0x74, 0x61, 0x12, 0x12, 0x0a, 0x04, 0x64, 0x61,
	...
	0x74, 0x73, 0x22, 0x26, 0x0a, 0x0a, 0x53, 0x4d, 0x54, 0x50, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74,
	0x12, 0x18, 0x0a, 0x07, 0x73, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28,
	0x08, 0x52, 0x07, 0x73, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x32, 0x39, 0x0a, 0x0b, 0x53, 0x4d,
	0x54, 0x50, 0x46, 0x6f, 0x72, 0x77, 0x61, 0x72, 0x64, 0x12, 0x2a, 0x0a, 0x08, 0x53, 0x65, 0x6e,
	0x64, 0x53, 0x4d, 0x54, 0x50, 0x12, 0x0c, 0x2e, 0x70, 0x62, 0x2e, 0x53, 0x4d, 0x54, 0x50, 0x44,
	0x61, 0x74, 0x61, 0x1a, 0x0e, 0x2e, 0x70, 0x62, 0x2e, 0x53, 0x4d, 0x54, 0x50, 0x52, 0x65, 0x73,
...
var file_pb_proto_goTypes = []interface{}{
	(*SMTPData)(nil),   // 0: pb.SMTPData
	(*SMTPResult)(nil), // 1: pb.SMTPResult
}
var file_pb_proto_depIdxs = []int32{
	0, // 0: pb.SMTPForward.SendSMTP:input_type -> pb.SMTPData
	1, // 1: pb.SMTPForward.SendSMTP:output_type -> pb.SMTPResult
